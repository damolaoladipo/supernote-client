            ...
            <div className="container">
                ...
                <div className="container-inner">
                    ...
                    <div className="auth-form"> 
                        ...
                        <Title text='Create Your Account' color='brand-green' size='fs-40' />
                        <p  className='fs-18 brand-gray font-dmsans' >Setting up an account takes less than one minute</p>
